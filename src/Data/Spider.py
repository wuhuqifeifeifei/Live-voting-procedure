...
class spider():
    ...
    def analyze_danmu(self, uid,uname, text):
        ...
        if text == '哈力木拉提·艾力、王奕番' or text == '哈力木拉提·艾力' or text == '王奕番' or text == '哈力木拉提艾力、王奕番' or text == '哈力木拉提艾力' or text == '哈力木拉提.艾力、王奕番' or text == '哈力木拉提.艾力':
            text = '哈力木拉提·艾力、王奕番'
        elif text == '玛迪娜·叶尔卡提' or text == '玛迪娜叶尔卡提' or text == '玛迪娜.叶尔卡提':
            text = '玛迪娜·叶尔卡提'
        elif text == '朱宝丽': 
            text = '朱寳麗'
        if text in self.ans:
